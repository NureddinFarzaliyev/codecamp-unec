...
export const data = {
    '.todo-header':  {en: 'Todo App', az: 'Ediləcəklər'},
    'title':  {en: 'To-Do List', az: 'Ediləcəklər'},
    '.welcome h1':  {en: 'Welcome to Todo App 👋', az: 'TodoList-ə Xoş Gəlmisiniz 👋'},
    '.welcome p':  {en: 'Please login or register in order to use the app.', az: 'Daxil olun və ya qeydiyyatdan keçin.'},
    '.login-section button':  {en: 'Login', az: 'Daxil Ol'},
    '.dont-account': {en: "Don't have an account? 😔", az: "Hesabınız Yoxdur? 😔"},
    '#create-account-btn': {en: "Create one! 😍", az: "Yaradın! 😍"},
    '.register-intro h1': {en: "Let's create a brand new account for you! 😎", az: "Gəlin sizə yeni bir hesab yaradaq! 😎"},
    '.register-intro p': {en: "Don't worry, it'll not take much time.", az: "Narahat olmayın, uzun çəkməyəcək."},
    '.choose-username h1': {en: "Think of a cool username for yourself!", az: "Özün üçün istifadəçi adı təyin et!"},
    ...
    '.choose-profile p': {en: "Please choose one of the avatars which will appear on your profile.", az: "Profilinizdə görünməsi üçün aşağıdakı şəkillərdən birini seçin."},
    '.done-message': {en: "Registration is done! ✅", az: "Qeydiyyatınız Tamamlandı! ✅"},
