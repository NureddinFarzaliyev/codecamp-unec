  ...
  return (
    <div className='min-h-72 w-full bg-main-text bg-opacity-5 banner bg-cover rounded-lg p-8'>
        <div className='lg:w-[35%]'>
            ...
            <button className='flex bg-white dark:bg-main-text py-2 px-4 rounded-full items-center gap-2 text-sm font-bold mt-4 lg:mt-10'>Shop Now <BsArrowRight /> </button>
        </div>
    </div>
  )
}
