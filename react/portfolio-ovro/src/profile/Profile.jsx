...
const Profile = () => {
  ...
  return (
    <div className='h-[75vh] w-[100%] bg-white/50 dark:bg-white/10 border-[1px] rounded-md border-white/10 md:sticky md:top-[50%] md:translate-y-[-50%] py-4 flex flex-col items-center justify-between'>
